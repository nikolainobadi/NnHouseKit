//
//  GenericDetailManagerTests.swift
//
//
...
final class GenericDetailManagerTests: XCTestCase {
...
// MARK: - Unit Tests
extension GenericDetailManagerTests {
...
extension GenericDetailManagerTests {
    ...
    func makeSUT(isCreator: Bool = false,
                 house: TestHouse? = nil,
                 file: StaticString = #filePath, line: UInt = #line) -> (sut: GenericDetailManager<TestHouse>, alerts: HouseDetailAlertsSpy, remote: HouseDetailRemoteAPISpy) {
        ...
        let adapter = makeAdapter(house: house,
                                  remote: remote)
        let sut = GenericDetailManager(isCreator: isCreator,
                                       alerts: alerts,
                                       adapter: adapter)
    ...
    func makeTestHouse(members: [HouseholdMember] = []) -> TestHouse {
    ...
    func makeAdapter(house: TestHouse, remote: HouseDetailRemoteAPISpy) -> MyAdapter<TestHouse> {
